...
const Profile = () => {
  ...
  const fetchWishlist = async () => {
    ...
    try {
      ...
      // Map wishlist items with centralized product data and clean up orphaned items
      ...
      for (const item of data || []) {
        ...
        if (product) {
          wishlistItemsWithProducts.push({
            ...item,
            products: {
              id: product.id,
              name: product.name,
      ...
      // Remove orphaned wishlist items (products that no longer exist)
      ...
      setWishlistItems(wishlistItemsWithProducts);
    } catch (error) {
