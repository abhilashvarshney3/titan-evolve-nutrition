...
// I Carry API Configuration
const ICARRY_CONFIG = {
  apiUrl: 'https://www.icarry.in/api_login', // I Carry API URL
  username: Deno.env.get('ICARRY_USERNAME') || 'ela31436', // I Carry username
  key: Deno.env.get('ICARRY_API_KEY') || '' // I Carry API key
};
